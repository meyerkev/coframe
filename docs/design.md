...
Redis is still the decision I am least confident about beyond the take-home scope. The queue is right for local operability, but it would be the first component I would replace if the team needed replayability, retention, or stronger delivery guarantees.
